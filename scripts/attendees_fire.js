...
var data = JSON.parse(fs.readFileSync("fire.json"))
...
db.once('open', function() {
    ...
    var Ducati = mongoose.model('fire_workshop', ducatiSchema);
    ...
    Ducati.collection.insert(data, function (err, docs) {
      if (err){ 
        ...
        console.log("Multiple documents inserted to Fire Workshop");
      }
    });
